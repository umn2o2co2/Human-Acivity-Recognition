# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 14:32:44 2019
...
model_cnn.add(Reshape((TIME_PERIODS, num_sensors), input_shape=(input_shape,)))
model_cnn.add(Conv1D(100, 10, activation='relu', input_shape=(TIME_PERIODS, num_sensors)))
model_cnn.add(Conv1D(100, 10, activation='relu'))
model_cnn.add(MaxPooling1D(3))
model_cnn.add(Conv1D(160, 10, activation='relu'))
model_cnn.add(Conv1D(160, 10, activation='relu'))
...
#%%
#Load model weights
model_cnn.load_weights('best_model.01-0.51.h5')
...
callbacks_list = [
    keras.callbacks.ModelCheckpoint(
        filepath='best_model.{epoch:02d}-{val_loss:.2f}cnn.h5',
